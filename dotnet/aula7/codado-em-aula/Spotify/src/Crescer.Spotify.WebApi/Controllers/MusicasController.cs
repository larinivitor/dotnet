...
namespace Crescer.Spotify.WebApi.Controllers
{
    ...
    public class MusicasController : Controller
    {
        ...
        public MusicasController(IMusicaRepository musicaRepository, MusicaService musicaService, IAlbumRepository albumRepository, SpotifyContext contexto)
        {
        ...
        public IActionResult GetAvaliacao(int id)
        {
            ...
            double nota = musicaRepository.ObterAvaliacao(id);
